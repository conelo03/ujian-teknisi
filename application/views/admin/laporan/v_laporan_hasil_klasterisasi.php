        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a class="btn btn-primary btn-flat" href="<?php echo base_url().'Admin/Laporan/laporan_klasterisasi_pdf/'.$ujian_id?>" target="_blank"><span class="fa fa-print"></span> Ekspor PDF</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
