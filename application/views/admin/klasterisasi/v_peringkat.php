        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h4>
                Data Peringkat Nilai Ujian
                <small></small>
              </h4>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-striped table-bordered table-hover" style="font-size:13px;">
                <thead>
                <tr>
                    <th rowspan="2" style="vertical-align: top;">No</th>
                    <th rowspan="2" style="vertical-align: top;">Nama Peserta</th>
                    <th colspan="4" style="text-align: center">Akumulasi Nilai Ujian</th>
                    <th style="text-align: center" rowspan="2">Akumulasi</th>
                </tr>
                <tr>
                  <?php 
                ...
                foreach ($akumulasi->result_array() as $i) :
                ?>
                <tr>
                  <td style="vertical-align: top;"><?php echo $no++;?></td>
                  <td><?php echo $i['nama_teknisi'];?></td>
                  <td style="text-align: center"><?php echo $i['pu'];?></td>
                  <td style="text-align: center"><?php echo $i['software'];?></td>
                  <td style="text-align: center"><?php echo $i['hardware'];?></td>
                  <td style="text-align: center"><?php echo $i['kelistrikan'];?></td>
                  <td style="text-align: center"><?php echo $i['akumulasi'];?></td>
