            ...
            <div class="box-body">
              ...
              <table id="" class="table table-striped table-bordered table-hover" style="font-size:13px;">
                ...
                <tr>
                    ...
                    <th><?php echo $c1a; ?></th><th><?php echo $c1b; ?></th><th><?php echo $c1c; ?></th><th><?php echo $c1d; ?></th>
                    <th><?php echo $c2a; ?></th><th><?php echo $c2b; ?></th><th><?php echo $c2c; ?></th><th><?php echo $c2d; ?></th>
                    <th><?php echo $c3a; ?></th><th><?php echo $c3b; ?></th><th><?php echo $c3c; ?></th><th><?php echo $c3d; ?></th>
                    <th><?php echo $c4a; ?></th><th><?php echo $c4b; ?></th><th><?php echo $c4c; ?></th><th><?php echo $c4d; ?></th>
                    <th><?php echo $c5a; ?></th><th><?php echo $c5b; ?></th><th><?php echo $c5c; ?></th><th><?php echo $c5d; ?></th>
                    <th><?php echo $c6a; ?></th><th><?php echo $c6b; ?></th><th><?php echo $c6c; ?></th><th><?php echo $c6d; ?></th>
                    <th><?php echo $c7a; ?></th><th><?php echo $c7b; ?></th><th><?php echo $c7c; ?></th><th><?php echo $c7d; ?></th>
                </tr>
                </thead>
                <tbody>
                <?php $nom = 1; ?>
                ...
                $q = "insert into centroid_temp(iterasi,c1,c2,c3,c4,c5,c6,c7) values('".$id."','".$arr_c1[$no]."','".$arr_c2[$no]."','".$arr_c3[$no]."','".$arr_c4[$no]."','".$arr_c5[$no]."','".$arr_c6[$no]."','".$arr_c7[$no]."')";
                $this->db->query($q);
