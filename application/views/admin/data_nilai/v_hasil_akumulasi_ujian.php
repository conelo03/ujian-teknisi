              ...
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td style="text-align:center;">
                      <a class="btn" href="<?php echo base_url().'admin/'.$user_id.'/'.$ujian_id.'/data-akumulasi-ujian.html';?>"><span class="fa fa-list"></span></a>
                  </td>
                    <?php } else { ?>
                  <td style="text-align:center;">
