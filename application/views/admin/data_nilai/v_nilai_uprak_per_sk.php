        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-default btn-flat" href="<?php echo base_url().'admin/'.$user_id.'/'.$ujian_id.'/data-akumulasi-ujian-praktek.html'?>"><span class="fa fa-arrow-left"></span> Kembali</a>
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Skor Sub Komponen</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td><?php echo $i['sk_uprak_nilai'];?></td>
                  <td style="width:123px;align:center;">
                    <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $i['nilai_sk_uprak_id'];?>"><span class="fa fa-pencil"></span></a>
                    <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $i['nilai_sk_uprak_id'];?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
        <?php endforeach;?>
                </tbody>
          ...
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      ...
                      <h4 class="modal-title" id="myModalLabel">Tambah Skor Sub Komponen Uprak</h4>
                  </div>
                  <form class="form-horizontal" action="<?php echo base_url().'Admin/Data_nilai/tambah_nilai_sk_uprak'?>" method="post" enctype="multipart/form-data">
                      ...
                      <label for="inputUserName" class="col-sm-4 control-label">Sub Komponen</label>
                        <div class="col-sm-7">
                          <select class="form-control" name="detail">
                            ...
                            <?php foreach ($subkomponen->result_array() as $k) :?>
                            <option value="<?= $k['sk_uprak_id'].'-'.$k['komponen_uprak_id']; ?>"><?php echo $k['sk_subkomponen']; ?></option>
                            <?php endforeach;?>
                          </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputUserName" class="col-sm-4 control-label">Skor (1-100)</label>
                        <div class="col-sm-7">
                          <input type="hidden" name="user_id" class="form-control" value="<?php echo $user_id?>" />
                          <input type="hidden" name="ujian_id" class="form-control" value="<?php echo $ujian_id?>" />
                          <input type="hidden" name="uprak_id" class="form-control" value="<?php echo $uprak_id?>" />
                          <input type="text" name="skor" class="form-control" id="inputUsername" />
                        </div>
                    </div>      
                  </div>
...
?>
<!--Modal Edit Pengguna-->
      <div class="modal fade" id="ModalEdit<?php echo $i['nilai_sk_uprak_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                      ...
                      <label for="inputUserName" class="col-sm-4 control-label">Komponen</label>
                        <div class="col-sm-7">
                          <select class="form-control" name="id_komponen">
                            ...
                            <?php foreach ($subkomponen->result_array() as $k) :?>
                            <option value="<?= $k['sk_uprak_id']; ?>"><?= $k['sk_subkomponen']; ?></option>
                            <?php endforeach;?>
                          </select>
                        </div>
                    </div>
...
<!--Modal Hapus Pengguna-->
      <div class="modal fade" id="ModalHapus<?php echo $i['nilai_sk_uprak_id'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
