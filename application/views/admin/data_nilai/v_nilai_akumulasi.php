            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                    ...
                    <th>Nama Teknisi</th>
                    <th>Kategori Soal</th>
                    <th style="width:150px;text-align: center;">Skor</th>
                    <th style="width:150px;text-align: center;">Skor Maksimal</th>
                </tr>
                </thead>
                <tbody>
                  <?php $no = 1; ?>
                <?php foreach ($data->result_array() as $i) :
                      ...
                      $akumulasi_skor=$i['skor'];
                      $max_skor=$i['skor_max_skor'];
                ?>
                <tr>
                  <td style="width:40px;"><?php echo $no++;?></td>
                  <td><?php echo $user_nama;?></td>
                  <td style="width:150px;"><?php echo $kategori_soal;?></td>
                  <td style="width:150px;text-align: center;"><?php echo $akumulasi_skor;?></td>
                  <td style="width:150px;text-align: center;"><?php echo $max_skor;?></td>
                </tr>
        <?php endforeach;?>
                </tbody>
              </table>
