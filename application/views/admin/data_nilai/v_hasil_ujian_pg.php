            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td>
                    <?php if(($h_ujian_status == '2') || ($h_ujian_status == '3') || ($h_ujian_status == '4')){
                      echo 'Selesai';
                    } else {
                      echo 'Sedang Mengerjakan';
                    }
                    ?>
                  
                  </td>
                  <td style="text-align:center;">
                        <a class="btn" href="<?php echo base_url().'admin/'.$user_id.'/'.$ujian_id.'/data-akumulasi-ujian-pg.html';?>"><span class="fa fa-list"></span></a>
                  </td>
                </tr>
				<?php endforeach;?>
                </tbody>
