...
<div class="content-wrapper">
    ...
    <div class="container">
        ...
        <section class="content">
            ...
            <form action="<?php echo base_url();?>Teknisi/Ujian/simpan_jawaban" method="post">
                ...
                <input type="hidden" name="soal_pg_id" id="tes-soal-id" value="<?php echo $soal->soal_pg_id; ?>">
                <input type="hidden" name="soal_pg_jawaban" id="tes-soal-id" value="<?php echo $soal->soal_pg_jawaban; ?>">
                <input type="hidden" name="soal_pg_bobot" id="tes-soal-id" value="<?php echo $soal->soal_pg_bobot; ?>">
        		...
        		<div class="box box-primary box-solid">
                    ...
                    <div class="box-body">
                        <?php if ($soal->soal_pg_media == NULL || $soal->soal_pg_media == 'default.jpg'):?>
                        <?php else :?>
                            <img src="<?= base_url().'upload/media/'.$soal->soal_pg_media?>" />
                        <?php endif;?>
                        <hr />
                        <div id="isi-tes-soal" style="font-size: 15px;">
                            <?php echo $soal->soal_pg_soal;?>
                            <hr />
                            <div class="form-group">
                                <?php if (empty($soal->nilai_pg_jawaban)):?>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="jawaban" value="a">
                                        a. <?php echo $soal->soal_pg_pil_a;?>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="jawaban" value="b">
                                        b. <?php echo $soal->soal_pg_pil_b;?>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="jawaban" value="c">
                                        c. <?php echo $soal->soal_pg_pil_c;?>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="jawaban" value="d">
                                        d. <?php echo $soal->soal_pg_pil_d;?>
                                    </label>
                                </div>
                                <?php else:?>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="jawaban" value="a" <?php if($soal->nilai_pg_jawaban == 'a'){ echo 'checked';}?>>
                                        a. <?php echo $soal->soal_pg_pil_a;?>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="jawaban" value="b" <?php if($soal->nilai_pg_jawaban == 'b'){ echo 'checked';}?>>
                                        b. <?php echo $soal->soal_pg_pil_b;?>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="jawaban" value="c" <?php if($soal->nilai_pg_jawaban == 'c'){ echo 'checked';}?>>
                                        c. <?php echo $soal->soal_pg_pil_c;?>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="jawaban" value="d" <?php if($soal->nilai_pg_jawaban == 'd'){ echo 'checked';}?>>
                                        d. <?php echo $soal->soal_pg_pil_d;?>
                                    </label>
                                </div>
                                <?php endif; ?>
                    ...
                    <div class="box-footer"> 
                        ...
                        <?php else:?>
                        <a href="<?php echo base_url().'Teknisi/Ujian/index/'.$ujian_id.'/'.$uri;?>" class="btn btn-default" id="btn-sebelumnya">Soal Sebelumnya</a>&nbsp;&nbsp;&nbsp;
                        <?php endif;?>
                        <label>
                            <input type="checkbox" style="width:15px;height:15px;" name="ragu" value="1" id="btn-ragu-checkbox" <?php if($soal->nilai_pg_ragu=='1'){ echo "checked"; } ?> /> Ragu-ragu
                        </label>
                        &nbsp;&nbsp;&nbsp;
                ...
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-body">
                        ...
                        foreach($daftar_soal as $s):
                            ...
                            ?>
                            <?php if($s->nilai_pg_ragu == '1'): ?>
                                <a href="<?php echo base_url().'Teknisi/Ujian/index/'.$ujian_id.'/'.$no_uri;?>" class="btn btn-warning" style="margin-bottom: 5px;"><?php echo $no_soall;?></a>
                            <?php elseif($s->nilai_pg_ragu == '0'): ?>
                                <a href="<?php echo base_url().'Teknisi/Ujian/index/'.$ujian_id.'/'.$no_uri;?>" class="btn btn-primary" style="margin-bottom: 5px;"><?php echo $no_soall;?></a>
                            <?php else: ?>
                                <a href="<?php echo base_url().'Teknisi/Ujian/index/'.$ujian_id.'/'.$no_uri;?>" class="btn btn-default" style="margin-bottom: 5px;"><?php echo $no_soall;?></a>
                            <?php endif; ?>
                        <?php endforeach;?>
        ...
        <form action="<?php echo base_url();?>Teknisi/Ujian/hentikan_tes" method="post">
                        ...
                        <div class="row-fluid">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="hentikan-dijawab" value="Soal Pilihan Ganda" readonly>
                                </div>
                            </div>
                            <div class="box-footer">
